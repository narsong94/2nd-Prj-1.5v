...
<link rel="stylesheet" type="text/css" href="${path}/resource/css/board/advice.css">
...
<div id="leftWrapper" class="clearfix">
         ...
         <div id="contentContainer">
            <div id="content">
                  ...
                  <div class="entry">
                     <div class="titleWrap floatWrapper">
                        ...
                        <!-- 자바스크립트 날짜 이미지 -->
                        <div class="dateImg"><span class="imgdate">${a.date}</span></div>
                        <h2>
                           <a href="/221">${a.title}</a>
                           <span class="category"><a href="/category/I.lib%28%29/I.lib%28JSTL%29">${a.writerId}</a></span><span class="date">${a.date }      조회수 : ${a.hit}</span></h2>
                     </div><!-- titleWrap close -->
            ...
            <div class="space"></div>
<!-- -----------------------------------2.좋아요 start-------------------------------------------------- -->
<%-- <input type="hidden" id="advice_id" name="advice_id" value="${img.id}" /> <a
...
<script>
	...
	$("#like_save").click(
			function() {
				...
				$.get("${path}/admin/board/advice/like/save?adviceId="
						+ $("#advice_id").val(), function(data) {
...
<img id="ccl-icon-221-2" class="entry-ccl-nd" src="https://t1.daumcdn.net/tistory_admin/static/admin/editor/ccl_black03.png?_version_=896dfff6a1b64c596188a1c1dc69a8070820800e" onmouseover="tistoryCcl.show(this, 1)" onmouseout="tistoryCcl.hide()" alt="변경 금지" style="width:15px;height:15px">
         ...
         <a href="../advice/${a.id}/edit"><img src="${path}/resource/img/설정.PNG" style="height: 20px; width:20px; "/></a>
         <a href="../advice/${a.id}/del"><img src="${path}/resource/img/삭제.png" style="height: 20px; width:20px; "/></a>
         </div>
      ...
      <div class="trailWrapper floatWrapper">
         ...
         <div class="author">
            <span class="text">Posted by </span>${a.date }
         </div>
      </div>
...
<script>
   $(function() {
      ...
      var saveComment = function() {
         ...
         $
               .ajax({
                  ...
                  url : '${path}/admin/board/advice/comment/save?${_csrf.parameterName}=${_csrf.token}',
                  dataType : 'gson',
      ...
      var updateComment = function() {
         ...
         $("#comment_area #data tr").remove();
         $.get(
               "${path}/admin/board/advice/comment/update-ajax?adviceId="
                     + $("#advice_id").val(), function(data) {
