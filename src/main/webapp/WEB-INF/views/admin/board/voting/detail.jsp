    	...
    	if( e.target.value == '이거 사' ) {
    		$.ajax({ // .like 버튼을 클릭하면 <새로고침> 없이 ajax로 서버와 통신하겠다.
     			type: "POST", // 데이터를 전송하는 방법을 지정
      			url: '${path}/admin/board/voting/'+id+'/like?num='+num+'&${_csrf.parameterName}=${_csrf.token}', // 통신할 url을 지정
...
<div class="gallery">
	<a target="_blank"> 
		<img src='${pic.get(0)}' alt="Forest" width="350" height="400">
	</a>
	<div class="desc">
		<input type="button" class="pic" name="1" value="이거 사">
		<a id="vote1">${vl.like1}</a>
  	</div>
</div>
<div class="gallery">
	<a target="_blank"> 
		<img src='${pic.get(1)}' alt="Forest" width="350" height="400">
	</a>
	<div class="desc">
		<input type="button" class="pic" name="2" value="이거 사">
		<a id="vote2">${vl.like2}</a>
  	</div>
</div>
<div class="gallery">
	<a target="_blank"> 
		<img src='${pic.get(2)}' alt="Forest" width="350" height="400">
	</a>
	<div class="desc">
		<input type="button" class="pic" name="3" value="이거 사"/>
		<a id="vote3">${vl.like3}</a>
  	</div>
</div>
</div>
...
<div id="result" style="display:none;">
	<table border="1" id="result-table">
		...
		<tr>
			<td>3번 후보</td>
			<td><a id="result-value3">${vl.like3}</a></td>
		</tr>
	</table>
