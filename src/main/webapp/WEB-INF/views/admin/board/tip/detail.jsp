            ...
            <div id="content">
                  ...
                  <div class="entry">
                     <div class="titleWrap floatWrapper">
                        ...
                        <!-- 자바스크립트 날짜 이미지 -->
                        <div class="dateImg"><span class="imgdate">${t.date}</span></div>
                        <h2>
                           <a href="/221">${t.title}</a>
                           <span class="category"><a href="/category/I.lib%28%29/I.lib%28JSTL%29">${t.writerId}</a></span><span class="date">${t.date }      조회수 : ${t.hit}</span></h2>
                     </div><!-- titleWrap close -->
...
<img id="ccl-icon-221-2" class="entry-ccl-nd" src="https://t1.daumcdn.net/tistory_admin/static/admin/editor/ccl_black03.png?_version_=896dfff6a1b64c596188a1c1dc69a8070820800e" onmouseover="tistoryCcl.show(this, 1)" onmouseout="tistoryCcl.hide()" alt="변경 금지" style="width:15px;height:15px">
         ...
         <a href="../tip/${t.id}/edit"><img src="${path}/resource/img/설정.PNG" style="height: 20px; width:20px; "/></a>
         <a href="../tip/${t.id}/del"><img src="${path}/resource/img/삭제.png" style="height: 20px; width:20px; "/></a>
         </div>
      ...
      <div class="trailWrapper floatWrapper">
         ...
         <div class="author">
            <span class="text">Posted by </span>${t.date }
         </div>
      </div>
